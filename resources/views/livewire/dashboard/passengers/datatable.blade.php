    ...
    <div class="card card-flush mt-6 mt-xl-9">
        <div class="card-header mt-5">
            <div class="card-title flex-column">
                <h3 class="fw-bolder mb-1">{{__("Passengers")}}</h3>
                    ...
                    <table id="kt_profile_overview_table"
                        ...
                        <thead class="fs-7 text-gray-400 text-uppercase">
                            <tr role="row">
                                ...
                                <th wire:click="sortBy('full_name')" data-sort="{{$sortDirection}}" class="min-w-50px">
                                    {{__("Full Name")}}
                                    ...
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="d-flex flex-column justify-content-center">
                                            <a href="{{route('admin.passengers.show',$passenger)}}"
                                                class="fs-6 text-gray-800 text-hover-primary">{{$passenger->full_name}}</a>
                                            <div class="fw-bold text-gray-400">{{$passenger->email}}</div>
                                            <div class="fw-bold text-gray-400">{{$passenger->mobile}}</div>
                                        </div>
                                    </div>
                                </td>
