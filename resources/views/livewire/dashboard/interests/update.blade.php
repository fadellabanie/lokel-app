    ...
    <div class="card mb-5 mb-xl-10">
        <div class="card-header border-0 cursor-pointer" role="button" data-bs-toggle="collapse"
            ...
            <div class="card-title m-0">
                <h3 class="fw-bolder m-0">{{__("Update Interest")}}</h3>
            </div>
        </div>
        <div id="kt_account_profile_details" class="collapse show">
            <form class="form">
                <div class="card-body border-top p-9">
                    <!--begin::Input group-->
                    <div class="row mb-6">
                        <x-label class="required">{{__("interest Name")}}</x-label>
                        <div class="col-lg-8">
                            <div class="row">
                                <div class="col-lg-12 fv-row">
                                    <x-input type="text" field="interest.name" wire:model="interest.name"
                                        placeholder="name" />
                                </div>
                    ...
                    <div class="row mb-0">
                        ...
                        <div class="col-lg-8 d-flex align-items-center">
                            <div class="col-12" x-data="{ isUploading: false, progress: 0 }"
                                ...
                                @elseif($interest->icon)
                                <div class="symbol symbol-150 mt-5">
                                    <img alt="" src="{{ asset($interest->icon) }}" />
                                </div>
                                @endif
                            </div>
                        </div>
